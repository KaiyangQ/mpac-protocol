# MPAC Specification v0.1.13

## 1. Status

This document defines version `0.1.13` of the Multi-Principal Agent Coordination Protocol (`MPAC`).
...
MPAC v0.1.13 defines a structured protocol for multi-agent collaboration centered on:
