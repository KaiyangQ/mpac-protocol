# MPAC Specification v0.1.10

## 1. Status

This document defines version `0.1.10` of the Multi-Principal Agent Coordination Protocol (`MPAC`).
...
| OPEN | `RESOLUTION` received | resolver has authority for the current conflict phase (owner/arbiter/coordinator) | RESOLVED | apply outcome, release frozen scope if any | resolver |
...
| ACKED | `RESOLUTION` received | resolver has authority for the current conflict phase | RESOLVED | apply outcome, release frozen scope if any | resolver |
