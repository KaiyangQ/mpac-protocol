...
|---------------|----------|------|---------------------------|
| Dad (张伟, 38) | `agent:dad-planner` | `owner` | Budget controller, driver. Loves nature, hiking, camping. Controls ¥15,000 total budget. Drives ≤5hr/day. |
| Mom (李娜, 36) | `agent:mom-planner` | `owner` | Food & accommodation lead. Cultural experiences, boutique minsu. **Allergic to all seafood** — critical constraint on every meal. |
| Kid (张小明, 12) | `agent:kid-planner` | `contributor` | Fun advocate. Theme parks (Hello Kitty Park), water activities, free play. Needs ≥1 unstructured day. |
...
- **Origin**: Shanghai
- **Destination area**: Moganshan (莫干山) / Anji (安吉), Zhejiang Province (~3.5hr drive)
- **Total budget**: ¥15,000
...
| Morning | Check into boutique minsu (竹林小筑), bamboo handicraft workshop | Mom |
