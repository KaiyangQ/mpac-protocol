# MPAC Specification v0.1.12

## 1. Status

This document defines version `0.1.12` of the Multi-Principal Agent Coordination Protocol (`MPAC`).
...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `event` | string | R | One of: `heartbeat`, `recovered`, `handover`, `assumed`, `authorization` |
