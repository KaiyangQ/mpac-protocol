# MPAC Specification v0.1.7

## 1. Status

This document defines version `0.1.7` of the Multi-Principal Agent Coordination Protocol (`MPAC`).
...
- intents with mandatory pre-execution declaration (Governance Profile) and formal state transition tables
...
- governance with deadlock prevention and three-phase frozen scope recovery
- causal context with baseline watermark interoperability and explicit Lamport clock maintenance rules
